...
bool vision_msg__msg__selected_id__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vision_msg.msg._selected_id.SelectedId", full_classname_dest, 38) == 0);
  }
  vision_msg__msg__SelectedId * ros_message = _ros_message;
  {  // time_stamp
...
{
  /* NOTE(esteve): Call constructor of SelectedId */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("vision_msg.msg._selected_id");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SelectedId");
