...
static const _DetectedId_type_support_symbol_names_t _DetectedId_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vision_msg, msg, DetectedId)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vision_msg, msg, DetectedId)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, vision_msg, msg, DetectedId)() {
  return &::vision_msg::msg::rosidl_typesupport_c::DetectedId_message_type_support_handle;
}
