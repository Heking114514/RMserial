...
{
  new (message_memory) def_msg::msg::GimblePosition(_init);
}

void GimblePosition_fini_function(void * message_memory)
{
  auto typed_message = static_cast<def_msg::msg::GimblePosition *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GimblePosition_message_member_array[4] = {
  {
    ...
    offsetof(def_msg::msg::GimblePosition, time_stamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(def_msg::msg::GimblePosition, yaw),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(def_msg::msg::GimblePosition, pitch),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(def_msg::msg::GimblePosition, armor_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GimblePosition_message_members = {
  ...
  4,  // number of fields
  sizeof(def_msg::msg::GimblePosition),
...
{
  return &::def_msg::msg::rosidl_typesupport_introspection_cpp::GimblePosition_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, def_msg, msg, GimblePosition)() {
  return &::def_msg::msg::rosidl_typesupport_introspection_cpp::GimblePosition_message_type_support_handle;
}
