...
static const _GimbleControl_type_support_symbol_names_t _GimbleControl_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, def_msg, msg, GimbleControl)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, def_msg, msg, GimbleControl)),
  }
};
...
{
  return &::def_msg::msg::rosidl_typesupport_cpp::GimbleControl_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, def_msg, msg, GimbleControl)() {
  return get_message_type_support_handle<def_msg::msg::GimbleControl>();
}
